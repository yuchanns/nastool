class SiteConf:
    ...
    # 站点登录界面元素XPATH
    SITE_LOGIN_XPATH = {
        "username": ['//input[@name="username"]', '//input[@id="form_item_username"]'],
        "password": ['//input[@name="password"]', '//input[@id="form_item_password"]'],
        "captcha": [
    ...
    PUBLIC_TORRENT_SITES = {
        "rarbg.to": {"parser": "Rarbg", "proxy": True, "language": "en"},
        "dmhy.org": {"proxy": True},
        "eztv.re": {"proxy": True, "language": "en"},
        "acg.rip": {"proxy": False},
        "thepiratebay.org": {"proxy": True, "render": True, "language": "en"},
        "nyaa.si": {"proxy": True},
        "1337x.to": {"proxy": True, "language": "en"},
        "ext.to": {"proxy": True, "language": "en", "parser": "RenderSpider"},
        "torrentgalaxy.to": {"proxy": True, "language": "en"},
        "mikanani.me": {"proxy": False},
        "gaoqing.fm": {"proxy": False},
        "www.mp4ba.vip": {"proxy": False, "referer": True},
        "www.miobt.com": {"proxy": True},
        "katcr.to": {"proxy": True, "language": "en"},
        "btsow.quest": {"proxy": True},
        "www.hdpianyuan.com": {"proxy": False},
        "skrbtla.top": {"proxy": False, "referer": True, "parser": "RenderSpider"},
        "www.comicat.org": {"proxy": False},
    }
