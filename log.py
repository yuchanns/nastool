...
class Logger:
    ...
    __loglevels = {"info": logging.INFO, "debug": logging.DEBUG, "error": logging.ERROR}
    ...
    def __init__(self, module):
        ...
        if logtype == "server":
            ...
            # 记录日志到文件
            logpath = (
                os.environ.get("NASTOOL_LOG")
                or self.__config.get_config("app").get("logpath")
                or ""
            )
            if logpath:
                ...
                log_file_handler = RotatingFileHandler(
                    filename=os.path.join(logpath, module + ".txt"),
